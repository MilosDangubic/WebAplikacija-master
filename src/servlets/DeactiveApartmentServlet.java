...
/**
 * Servlet implementation class DeactiveApartmentServlet
 */
@WebServlet("/DeactiveApartmentServlet")
public class DeactiveApartmentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeactiveApartmentServlet() {
        super();
